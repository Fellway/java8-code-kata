...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(a->a.getAge()).sorted();
    ...
    public void descSortByAge() {
        ...
        Stream<Integer> sortedAgeStream = customerList.stream().map(a->a.getAge()).sorted(descOrder);
    ...
    public void distinctAge() {
         ...
         */
        Stream<Integer> distinctAgeStream = customerList.stream().map(a->a.getAge()).distinct();
    ...
    public void itemsCustomersWantToBuy() {
        ...
        Stream<String> itemStream = customerList.stream().flatMap(getItemStream).map(a->a.getName());
