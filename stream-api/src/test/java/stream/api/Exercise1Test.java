...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void findRichCustomers() {
        ...
        Stream<Customer> richCustomerStream = customerList.stream().filter(a->a.getBudget()>10000);
    ...
    public void howOldAreTheCustomers() {
        ...
        Function<Customer, Integer> getAgeFunctionReference = new Function<Customer, Integer>() {
            @Override
        ...
        Stream<Integer> ageStream = customerList.stream().map(a->getAgeFunction.apply(a));
