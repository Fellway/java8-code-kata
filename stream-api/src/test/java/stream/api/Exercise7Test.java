...
public class Exercise7Test extends ClassicOnlineStore {
    ...
    public void averageAge() {
         ...
         */
        IntStream ageStream = customerList.stream().mapToInt(a->a.getAge());
    ...
    public void howMuchToBuyAllItems() {
         ...
         */
        LongStream priceStream = shopList.stream().flatMap(a->a.getItemList().stream()).mapToLong(a->a.getPrice());
