...
public class Exercise3Test extends ClassicOnlineStore {
    ...
    public void howManyItemsWanted() {
        ...
        long sum = customerList.stream().flatMap(a->a.getWantToBuy().stream()).count();
    ...
    public void richestCustomer() {
        ...
        Optional<Integer> richestCustomer = customerList.stream().map(a->a.getBudget()).max(comparator);
