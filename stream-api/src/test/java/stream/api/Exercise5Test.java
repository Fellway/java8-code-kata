...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void nameList() {
         ...
         */
        List<String> nameList = customerList.stream().map(a->a.getName()).collect(Collectors.toList());
    ...
    public void ageSet() {
         ...
         */
        Set<Integer> ageSet = customerList.stream().map(a->a.getAge()).collect(Collectors.toSet());
    ...
    public void nameInCsv() {
         ...
         */
        String string = customerList.stream().map(a->a.getName()).collect(Collectors.joining(",","[","]"));
    ...
    public void ageDistribution() {
         ...
         */
        Map<Integer, Long> ageDistribution = customerList.stream().collect(Collectors.groupingBy(a -> a.getAge(), Collectors.counting()));
